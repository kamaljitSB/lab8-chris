...
def populate_stats():
    ...
    events = requests.get(f'http://35.192.222.219/storage/buy?timestamp={last_updated}')
    ...
    events = requests.get(f'http://35.192.222.219/storage/sell?timestamp={last_updated}')
